...
class LevelSelectScene: SKScene {
    ...
    func switchToGameScene(level: Level) {
        ...
        let newScene = GameScene(size: self.size, level: level, section: 4, gameControllerManager: gameControllerManager!, spawn : level.sections[0].spawnEntry, hapticsManager: hapticsManager!)
